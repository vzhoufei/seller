	...
	<section class="main_goods">
		...
		<div class="main_goodsO" style='padding-bottom:40px;'>
			<div class="mian_goodO6">
				...
				<div class='page'>
					<div class='pre'><?php if($pre == null): ?>没有上一篇<?php else: ?><a href="<?php echo U('Store/Newscontent',array('store_id'=>$store[store_id],'sn'=>$sn_id,'text'=>$pre));?>">上一篇</a><?php endif; ?></div>
					<div class='next'><?php if($next == null): ?>没有下一篇<?php else: ?><a href="<?php echo U('Store/Newscontent',array('store_id'=>$store[store_id],'sn'=>$sn_id,'text'=>$next));?>">下一篇</a><?php endif; ?></div>
				</div>
			<style>
				.info{
					height: 20px;
