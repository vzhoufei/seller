			...
			<div class="hnavone">
				...
				<div class="hnavoneM">
					<div class="hnavoneMo">
						...
						<!-- <div class="hnavoneM2"><a href="<?php echo U('Store/index',array('store_id'=>$store[store_id]));?>">品牌：云迪</a></div> -->
					</div>
						<div class="hnavoneM3">
							<a href="#">货描<?php echo ($store["store_desccredit"]); ?><!-- <img src="<?php echo STYLE;?>/images/shang.png"> --></a>
							<a href="#">响应<?php echo ($store["store_servicecredit"]); ?><!-- <img src="<?php echo STYLE;?>/images/shang.png"> --></a>
							<a href="#">发货<?php echo ($store["store_deliverycredit"]); ?><!-- <img src="<?php echo STYLE;?>/images/shang.png"> --></a>
							<!-- <a href="#">回头率60%<img src="<?php echo STYLE;?>/images/shang.png"></a> -->
						</div>
				</div>
				<div class="hnavoneR">
						<div class="hnavoneRo">
...
<!-- 产品专区 -->
 <?php if(($goods_list)): ?><section class="main_goods">
		<!-- 产品部分开始 -->
		<div class="main_goodsO">
				...
				<div class="mian_goodO6">
					...
					<!-- 产品右边部分 -->
					<div class="mian_goodO6Rssss" >
						<div class="main_list_page">
						<div class="mian_goodO6ROne">
				<div class="mian_goodO6ROneC">
					<ul>
		        ...
		        <a  <?php if($link[key] == $keys): ?>class="<?php echo ($sort); ?>"<?php endif; ?> href="<?php echo ($link["url"]); ?>"><?php echo ($link["name"]); ?></a>
						...
						<div class="mian_goodlist">
							<ul>

         						<?php if(is_array($goods_list)): foreach($goods_list as $key=>$vo): ?><li><a target="_blank" href="<?php echo C('DOMAIN'); echo U('Goods/goodsInfo',array('id'=>$vo[goods_id]));?>"><img src="<?php echo (goods_thum_images($vo["goods_id"],240,240)); ?>" class="img" /></a>					
									<span class="mian_goodO5M">¥<b><?php echo ($vo["shop_price"]); ?></b></span>
									<a target="_blank" href="<?php echo C('DOMAIN'); echo U('Goods/goodsInfo',array('id'=>$vo[goods_id]));?>" class="mian_goodO5T"><?php echo (getSubstr($vo["goods_name"],0,20)); ?></a>
									<a target="_blank" href="<?php echo C('DOMAIN'); echo U('Goods/goodsInfo',array('id'=>$vo[goods_id]));?>" class="qianggoua">

										<?php if($vo[prom_type] > 0): ?><div class="qianggou"><span class="qianggou2">
									...
									<span class="mian_goodO6R1N">成交<?php echo ($vo["sales_sum"]); ?>笔</span>	
										<div class="jiagou"><a href="<?php echo C('DOMAIN'); echo U('Goods/goodsInfo',array('id'=>$vo[goods_id]));?>">加入进货单</a></div>							
									</li><?php endforeach; endif; ?>
