...
<head>
	<meta charset="UTF-8">
	<title><?php echo ($navlist["sn_title"]); ?></title>
	 <meta name="keywords" content="<?php echo ($navlist["sn_keyword"]); ?>" />
    <meta name="description" content="<?php echo ($navlist["sn_description"]); ?>"/>
...
<img src="<?php echo ($navlist["sn_pic"]); ?>" style="width:100%;"  />
  <div class="wrapper" style="margin-top: 10px;" >
    <div class="ncs-article">
      <div class="ncs-main-container">
        <div class="title">
          <h2 style="width:1200px;margin:0 auto;text-align:center;margin-bottom:10px;"><?php echo ($navlist["sn_title"]); ?></h2>
        </div>
        <div class="content">
          <div class="default" style="width:1200px;margin:0 auto;overflow: hidden;"><?php echo (htmlspecialchars_decode($navlist["sn_content"])); ?></div>
        </div>
      </div>
    </div>
  </div>
