						...
						<ul class='news'>
							<?php if(is_array($news)): foreach($news as $key=>$v): ?><li>
								<a href="
									...
									<?php if(($nav_where)): echo U('Store/article',array('text'=>$v[id]));?>
							<?php else: ?>
							<?php echo U('Store/Newscontent',array('store_id'=>$store[store_id],'text'=>$v[id])); endif; ?>
								...
								<div class='n-title'>
									<?php echo (mb_substr($v["shorttitle"],0,20,'utf-8')); ?>...
								</div>
