			...
			<div class="content">
				...
				<div class="w3agile properties">
					...
					<?php if(is_array($hot_goods)): foreach($hot_goods as $key=>$v): ?><div class="properties-bottom">
						...
						<div class="w3ls-text">
							<h5 style="height: 30px;"><a href="<?php echo U('Goods/goodsInfo',array('id'=>$v[goods_id]));?>"><?php echo mb_substr($v['goods_name'],0,26,'utf-8');?></a></h5>
							<h6>￥<?php echo ($v["shop_price"]); ?></h6>
							<p><b>已卖出</b><?php echo ($v["click_count"]); ?>件</p>
							<p><a href="<?php echo U('Goods/goodsInfo',array('id'=>$v[goods_id]));?>" class="lijigoumai">立即购买</a></p>
						</div>
					</div><?php endforeach; endif; ?>
					<div class="clearfix"> </div>
				</div> 
