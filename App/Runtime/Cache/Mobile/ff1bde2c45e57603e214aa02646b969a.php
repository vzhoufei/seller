...
<style>.default p{text-indent:2em;}.default img{width:100%;} </style>
<!-- <img src="<?php echo ($news["sn_pic"]); ?>" style="width:100%;"  /> -->
  <div class="wrapper" style="margin-top: 10px;" >
    <div class="ncs-article">
      <div class="ncs-main-container">
        <div class="title">
          <h2 style="width:100%;margin:0 auto;text-align:center;margin-bottom:10px;font-size:16px;"><?php echo ($news["sn_title"]); ?></h2>
        </div>
        <div class="content">
          <div class="default" style="width:100%;margin:0 auto;overflow: hidden;font-size:16px;"><?php echo (htmlspecialchars_decode($news["sn_content"])); ?></div>
        </div>
      </div>
    </div>
  </div>
